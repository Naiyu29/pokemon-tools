// 產生 data/zh-names.json：招式／特性 英文→繁中 對照表（網頁顯示用）
// 來源：PokeAPI 官方 CSV（move_names.csv / ability_names.csv，local_language_id=4 = 繁體中文）
...
// 只收 @smogon/calc gen9 實際存在的招式／特性，控制檔案大小
const out = { moves: {}, abilities: {} };
const missMoves = [], missAbilities = [];
